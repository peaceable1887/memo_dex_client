...
class SwitchDisableAutocorrectBtn extends StatefulWidget
{
  final String buttonText;
  final List<double> buttonBorderRadius;

  const SwitchDisableAutocorrectBtn({
    super.key,
    required this.buttonText,
    required this.buttonBorderRadius});

  @override
  State<SwitchDisableAutocorrectBtn> createState() => _SwitchDisableAutocorrectBtnState();
}

class _SwitchDisableAutocorrectBtnState extends State<SwitchDisableAutocorrectBtn>
{
  ...
  void toggleDisableAutocorrect(bool value)
  {
    if(value == true)
    {
